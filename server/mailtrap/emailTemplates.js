...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <p>Best regards,<br>Pritam Kumar Manohari</p>
  </div>
        ...
        <td valign="top" align="center">
          <table class="container" width="600" cellspacing="0" cellpadding="0" border="0">
            <tbody>
              ...
              <img src="https://mailsend-email-assets.mailtrap.io/2f0jeljnua9jqu5h36ee4k03qk93.jpg" alt='future' style="width:100%; margin-bottom:25px;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Thanks for choosing to visit my site! I am happy to see you on board.
                        </td>
                      </tr>
                      <tr>
